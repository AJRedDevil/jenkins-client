  ...
  try {
    ...
    if (property) {
      ...
      if (type === 'array') {
        ...
        try {
          for (
            var _iterator2 = property[Symbol.iterator](), _step2;
...
exports.init = function(host, defaultOptions, defaultParams) {
  ...
  return {
    ...
    /** */
    build_with_params: function build_with_params(
      jobName,
      customParams,
      callback
    ) {
    ...
    console_output: function console_output(
      jobName,
      buildNumber,
      customParams,
      callback
    ) {
      var _doArgs9 = doArgs(arguments, [
        'string',
        'string|number',
        ['object', {}],
        'function',
    ...
    build_info: function build_info(
      ...
      var _doArgs15 = doArgs(arguments, [
        'string',
        'string|number',
        ['object', {}],
        'function',
    ...
    all_builds: function all_builds(jobName, param, customParams, callback) {
      ...
      var _doArgs17 = doArgs(arguments, [
        'string',
    ...
    test_result: function test_result(
      jobName,
      buildNumber,
      customParams,
      callback
    ) {
      var _doArgs19 = doArgs(arguments, [
        'string',
        'string|number',
        ['object', {}],
        'function',
    ...
    delete_build: function delete_build(
      jobName,
      buildNumber,
      customParams,
      callback
    ) {
      var _doArgs21 = doArgs(arguments, [
        'string',
        'string|number',
        ['object', {}],
        'function',
    ...
    update_config: function update_config(
      jobName,
      modifyFunction,
      customParams,
      callback
    ) {
      var _doArgs27 = doArgs(arguments, [
        'string',
        'function',
        ['object', {}],
        'function',
    ...
    update_job: function update_job(
      ...
      var _doArgs29 = doArgs(arguments, [
        'string',
        'string',
        ['object', {}],
        'function',
    ...
    create_job: function create_job(
      ...
      var _doArgs33 = doArgs(arguments, [
        'string',
        'string',
        ['object', {}],
        'function',
    ...
    copy_job: function copy_job(
      ...
      var _doArgs35 = doArgs(arguments, [
        'string',
        'string',
        'function',
        ['object', {}],
    ...
    queue_item: function queue_item(queueNumber, customParams, callback) {
      var _doArgs49 = doArgs(arguments, [
        'string|number',
        ['object', {}],
        'function',
      ]);
    ...
    cancel_item: function cancel_item(itemId, customParams, callback) {
      var _doArgs51 = doArgs(arguments, [
        'string|number',
        ['object', {}],
        'function',
      ]);
    ...
    create_view: function create_view(viewName, mode, customParams, callback) {
      var _doArgs57 = doArgs(arguments, [
        'string',
    ...
    update_view: function update_view(
      ...
      var _doArgs61 = doArgs(arguments, [
        'string',
        'object',
        ['object', {}],
        'function',
    ...
    /** */
    add_job_to_view: function add_job_to_view(
      viewId,
      jobName,
      customParams,
      callback
    ) {
      var _doArgs65 = doArgs(arguments, [
        'string',
        'string',
        ['object', {}],
        'function',
    ...
    /** */
    remove_job_from_view: function remove_job_from_view(
      viewId,
      jobName,
      customParams,
      callback
    ) {
      var _doArgs67 = doArgs(arguments, [
        'string',
        'string',
        ['object', {}],
        'function',
    ...
    all_installed_plugins: function all_installed_plugins(
      customParams,
      callback
    ) {
